...
@section('content')
    ...
    <a href="{{ route('admin.user.create') }}" class="inline-flex items-center px-4 py-2 bg-blue-500 text-white font-medium text-sm rounded-lg hover:bg-blue-600 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2">Tambah user</a>
