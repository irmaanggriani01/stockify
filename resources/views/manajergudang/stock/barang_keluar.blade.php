...
@section('content')
    <div class="container mx-auto p-4">
        ...
        <h1 class="text-2xl font-semibold mb-6">Transaksi Barang Keluar</h1>

        <form action="{{ route('manajergudang.stock.store_barang_keluar') }}" method="POST"
            ...
            <button type="submit"
                class="w-full py-2 px-4 bg-red-600 text-white font-semibold rounded-lg hover:bg-red-700 focus:outline-none focus:ring-2 focus:ring-red-500">
